...
#these first bits of code is for the setup 



l_dk <- leaflet() %>%   # assign the base location to an object
  setView(lng = 8.7300804, lat = 55.9382936, zoom = 10) 
...
#the code to get acces to google sheets 
...
#this is the code to add the clusters
...
# The map is good for an easy overview of locations and the surrounding landscape, 
#it is not very detailed however and there are no notes with the locations

# Task 5: Find out how to display notes and classifications in the map.

# Der må jeg sgu melde pas min ven
