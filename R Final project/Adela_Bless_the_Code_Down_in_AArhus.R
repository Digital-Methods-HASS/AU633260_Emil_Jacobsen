...
#Line 7-10 --> line 14-15 --> line 20-62
...
#if it does not work, pls run the code on line on line 76 instead, it should work just as well, but do keep in mind that the project was originally made with google sheets and bugs may occour
